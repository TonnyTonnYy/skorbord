...
class App extends Component {
  ...
  saveChanges = gameId => {
    const game = this.state.games.find(el => (el._id = gameId));
    // API.post("/", { id: gameId, teams: game });
    console.log(` siemanko : ${game}`);
  };
  ...
  toggleChoose = () => {
    ...
    this.saveChanges("5de4f9722a2a0f1ef7f0ba40");
  };
    ...
    if (this.state.chooseToggle === true) {
      ...
      return (
        <div class="container wrapper">
          <div className="exit hv-c" onClick={this.toggleChoose}>
            X
          </div>
          <BoxScore
