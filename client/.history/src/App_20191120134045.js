...
class App extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <div className="score-bar hv-c" data={this.state.teams}></div>
        <div className="main-bar wrapper" data={this.state.teams}></div>
        <div className="logs-bar" data={this.state.teams}></div>
      </React.Fragment>
    );
  }
}
