...
class App extends Component {
  ...
  updateScore = (side, input, sign) => {
    console.log(`Update score : ${side} ${input} ${sign}`);
    const id = this.state.teams.findIndex(
      el => el.side === side
    ); /* how to find index of object in array-of-objects */
  ...
  updatePlayer = (side, input, num, sign) => {
    console.log(`Update player ${side} ${input} ${num} ${sign}`);
    // const id = this.state.teams.indexOf(el => el.side === side);
  ...
  updateHistory = (side, input, num) => {
    console.log(`Update history : ${side} ${input} ${num}`);
    // const id = this.state.teams.indexOf(el => el.side === side);
    // this.setState(state =>
